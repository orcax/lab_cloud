...
angular.module('labcloud')
  .factory('StudentRecord', function($resource, sessionService, $rootScope) {
    var baseUrl = '/api/studentRecords';
    ...
    return {
      ...
      lashenreport: function(){
        return $resource('http://10.10.92.189:8081/ReportService.asmx/GenerateLaShenReport',{},{
          'get':{
            method:'GET',
            headers:{
      ...
      niuzhuanreport: function(){
        return $resource('http://10.10.92.189:8081/ReportService.asmx/GenerateNiuZhuanReport',{},{
          'get':{
            method:'GET',
            headers:{
              'Content-Type':'application/x-www-form-urlencoded'
